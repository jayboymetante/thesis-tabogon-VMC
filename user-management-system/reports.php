    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="reports.php" class="list-group-item list-group-item-action bg-transparent active second-text fw-bold"><i
            ...
            <div class="container-fluid px-4">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="vaccine-used.php">Vaccine Used</a>
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                        ...
                        <?php
                            ...
                            echo "</td>";
                            echo "<td>";
                            echo ' <a href="print-vaccine-data.php?user_info_id='.$data["user_info_id"].'"><button class="btn btn-secondary">Print Vaccine Data</button>';
                            echo "</td>";
                            echo "<td>";
