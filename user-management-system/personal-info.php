    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="personal-info.php" class="list-group-item list-group-item-action bg-transparent active second-text fw-bold "><i
                        class="fas fa-users ">
                    </i>Personal Info</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Residents List</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                <button type="button" class="btn btn-primary" data-toggle="modal">
                    Add New Resident<i class="fa fa-plus" aria-hidden="true"></i>
                </button>
                    <div class="col">
